...
//@Component
//@Slf4j
//public class ChannelPartnerClient2 {
//
//    @Autowired
...
//
//    public void callCP(AgentInformation agentInformation){
...
//        body.put("msisdn",agentInformation.getMsisdn());
//        HttpEntity<Map<String, String>> entity = new HttpEntity<>(body, headers);
//
//        ResponseEntity<ChannelPartner> cp = restTemplate.exchange(url, HttpMethod.POST, entity, ChannelPartner.class);
//
//        processResponse(cp.getBody(), agentInformation);
//    }
//
//    private void processResponse(ChannelPartner cp, AgentInformation agentInformation) {
...
//                log.info("Updated Wallet Information for msisdn - {}", agentInformation.getMsisdn());
//            }else {
//                log.info("MQ Error while updating msisdn - {} with error - {}", agentInformation.getMsisdn(), updateResp);
//            }
//
//        }else {
//            log.info("No record found for msisdn - {}", agentInformation.getMsisdn());
//        }
//    }
//}
